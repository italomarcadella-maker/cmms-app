...
interface AIDailyBriefProps {
    initialInsights?: DailyInsight[];
}

export function AIDailyBrief({ initialInsights = [] }: AIDailyBriefProps) {
    const [insights, setInsights] = useState<DailyInsight[]>(initialInsights);
