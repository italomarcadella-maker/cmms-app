            ...
            <div className="space-y-4 py-4">
                <div className="px-4 py-2">
                    ...
                    <div className="space-y-1">
                        ...
                        <Link href="/requests/new" className="flex items-center gap-3 rounded-md px-2 py-2 text-sm font-medium hover:bg-muted hover:text-foreground">
                            <PlusCircle className="h-4 w-4" />
                            Inserimento Richiesta
                        </Link>

                        {user?.role !== 'USER' && (
                            <Link href="/work-orders?tab=requests" className="flex items-center gap-3 rounded-md px-2 py-2 text-sm font-medium hover:bg-muted hover:text-foreground group">
